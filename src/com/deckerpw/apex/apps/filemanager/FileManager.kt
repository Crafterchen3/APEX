...
import com.deckerpw.apex.apps.settings.SettingsWindow
...
@Program
class FileManager : Executable {
    override fun onStart() {
        machine.windowManager?.add(FileManagerWindow(machine.windowManager))
    }
}

class FileManagerWindow(parent: WindowManager?): Window(parent, 100, 100, 400, 400, "File Manager") {
